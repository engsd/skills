...
| `document` | Essays, articles, reading lists, bookmarks, research collections, PDFs, DOCX, legal/medical/lab/academic records | **Document Review**: auto-adapts to article-magazine for narrative articles, docs-page for technical guides, or a formal evidence surface for records. |
| `kami-reading` | Long prose, DOCX memos, articles, essays, one-pagers, letters, reports, and manuscripts meant for sustained reading | **Kami Parchment Document**: uses the integrated `doc-kami-parchment` reference, with warm paper, serif masthead, ink-blue restraint, and print-like composition. |
